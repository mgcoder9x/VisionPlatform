...
| D-059 | ✅ | SẢN PHẨM — `object-tracking-count` HOÀN TẤT (design #258 + code TDD #259): analytics STATEFUL đầu tiên (tracking IoU-greedy + đếm-không-trùng), đóng Lỗ 3/K-042. 3 lớp domain(greedy_associate)/kernel(Track/ITracker)/runtime(IouTracker/TrackingStage) + 14 test. Additive (không sửa CountStage). **VERIFY: 479/1 · lint 5/0 · drift PASS** | #258,#259 |
