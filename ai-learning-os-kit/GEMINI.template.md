...
2. **Router — tự chọn chế độ**, in "→ Chế độ: HỌC/XÂY/REVIEW/ÔN/HỎI NHANH". Override `[học] [xây] [ôn] [review]`. Không bắt copy prompt.
...
📖 Đọc & tổng hợp ngữ cảnh lớn, giải thích tổng thể. Ghi phát hiện vào `memory-bank/activeContext.md`.
